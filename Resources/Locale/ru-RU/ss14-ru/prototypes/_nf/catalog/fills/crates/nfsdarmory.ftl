ent-CrateArmorySMGNfsd = ящик пистолетов пулемётов Frontline Solutions
    .desc = Содержит два мощных пистолета-пулемёта и четыре магазина. Чтобы открыть необходим доступ уровня Оружейной.
ent-CrateArmoryShotgunNfsd = ящик дробовиков Frontline Solutions
...
ent-CrateTrackingImplantsNfsd = ящик имплантов Frontline Solutions
...
ent-CrateTrainingBombsNfsd = ящик тренировочных бомб Frontline Solutions
...
ent-CrateArmoryLaserNfsd = ящик лазеров Frontline Solutions
    .desc = Содержит три стандартные лазерные винтовки. Чтобы открыть необходим доступ уровня Оружейной.
ent-CrateArmoryPistolsNfsd = ящик пистолетов Frontline Solutions
