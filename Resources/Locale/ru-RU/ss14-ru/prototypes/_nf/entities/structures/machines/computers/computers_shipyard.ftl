...
ent-ComputerShipyardSecurity = консоль приёма в Frontline Solutions
...
ent-ComputerShipyardNfsd = консоль верфи Frontline Solutions
    .desc = Здесь вы можете приобрести патрульные шаттлы Frontline Solutions, оснащенные новейшими технологиями и готовые к самым сложным заданиям. Поддержите закон и порядок среди звезд, используя надежные и мощные шаттлы, созданные для настоящих героев.
...
ent-ComputerShipyardSr = консоль верфи Представителя Горизонта
